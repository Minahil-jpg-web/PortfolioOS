...
import { FaTrophy, FaCode, FaLaptopCode } from "react-icons/fa6";
...
const screenshots = [
  {
    title: "Login Screen",
    description:
      "Secure authentication interface for doctors and administrators.",
  ...
  },
  {
    ...
    description:
      "Analyze patient medical records and generate disease predictions.",
    image: "/assets/projects/kidney-disease/gallery/patient-analysis.jpg",
  },
  {
    title: "Prediction Result",
    description:
      "Machine learning prediction results with confidence insights.",
...
const workflowSteps = [
  ...
  },
  {
    ...
    title: "ML Processing",
    description:
      "The trained machine learning model analyses the patient data.",
  },
  {
    step: "03",
...
const studentProject = {
  ...
  subtitle: "Streamlining academic administrative workflows.",
  ...
  techStack: ["MySQL", "SQL", "C++", "Relational Database Design"],
...
const dashboardProject = {
  ...
  subtitle: "A bespoke tool for productivity and progress monitoring.",
  ...
  techStack: ["HTML5", "CSS3", "JavaScript", "Chart.js", "Flexbox", "CSS Grid"],
...
const dashboardScreenshots = [
  ...
  },
  {
    ...
    title: "Goals",
    description: "Track long-term goals, milestones and personal achievements.",
  },
];
...
const neuralProject = {
  ...
  techStack: ["Python", "NumPy", "Manim (Math Animation Engine)"],
    ...
    <section className="relative bg-[#050816] py-28">
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <div className="mt-5 max-w-3xl">
            <p className="text-lg leading-8 text-slate-400">
              This project combines machine learning, data preprocessing and
              healthcare analytics to provide accurate kidney disease prediction
        ...
        <motion.div
          ...
          className="mt-24"
        >
          <h2 className="text-4xl font-bold text-white">Project Statistics</h2>
        ...
        >
          ...
          <div className="mt-8 max-w-4xl space-y-6">
            {studentProject.description.map((text, index) => (
              <p key={index} className="text-lg leading-8 text-gray-400">
                {text}
              </p>
            ))}
          </div>
      ...
      "
        ...
        >
          ...
          <div className="mt-8 max-w-4xl space-y-6">
            {dashboardProject.description.map((text, index) => (
              <p key={index} className="text-lg leading-8 text-slate-400">
                {text}
              </p>
            ))}
          </div>
        ...
        >
          ...
          >
            ...
            <h3 className="mt-5 text-2xl font-semibold text-white">Outcome</h3>
        ...
        >
          <div className="grid gap-8 lg:grid-cols-3">
            ...
            >
              ...
              <h3 className="mt-6 text-3xl font-bold text-white">Outcome</h3>
            ...
            >
              ...
              <h3 className="mt-6 text-3xl font-bold text-white">Tech Stack</h3>
        ...
        <motion.section
          ...
          className="mt-24"
        >
          <h2 className="text-4xl font-bold text-white">Core AI Concepts</h2>

          <div className="mt-4 h-1 w-48 rounded-full bg-gradient-to-r from-fuchsia-500 via-violet-500 to-cyan-400" />

          <p className="mt-6 max-w-3xl text-lg leading-8 text-slate-400">
            This prototype transforms complex artificial intelligence concepts
            into interactive visual experiences, making neural network learning
            easier to understand for students and developers.
          </p>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            >
              ...
              Full Stack Development, or innovative software solutions, I'd love
